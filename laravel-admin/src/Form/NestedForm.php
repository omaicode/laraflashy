...
namespace Omaicode\Admin\Form;

use Omaicode\Admin\Admin;
use Omaicode\Admin\Form;
use Omaicode\Admin\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \Omaicode\Admin\Form|\Omaicode\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \Omaicode\Admin\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
