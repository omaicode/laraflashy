...
use Omaicode\Admin\Actions\Action;
use Omaicode\Admin\Actions\GridAction;
use Omaicode\Admin\Actions\Response;
use Omaicode\Admin\Actions\RowAction;
use Omaicode\Admin\Widgets\Form;
use Exception;
...
class HandleController extends Controller
{
    ...
    public function handleSelectable(Request $request)
    {
        ...
        if (class_exists($class)) {
            /** @var \Omaicode\Admin\Grid\Selectable $selectable */
