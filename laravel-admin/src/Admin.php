...
namespace Omaicode\Admin;

use Closure;
use Omaicode\Admin\Auth\Database\Menu;
use Omaicode\Admin\Controllers\AuthController;
use Omaicode\Admin\Layout\Content;
use Omaicode\Admin\Traits\HasAssets;
use Omaicode\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \Omaicode\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \Omaicode\Admin\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\Omaicode\Admin\Controllers')->group(function ($router) {
