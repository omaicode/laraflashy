...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Omaicode\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Omaicode\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Omaicode\Admin\AdminServiceProvider']);
...
//        \Omaicode\Admin\Admin::$css = [];
//        \Omaicode\Admin\Admin::$js = [];
//        \Omaicode\Admin\Admin::$script = [];
    }
