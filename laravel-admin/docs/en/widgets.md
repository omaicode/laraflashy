...
`Omaicode\Admin\Widgets\Box` used to generate box components:

```php
use Omaicode\Admin\Widgets\Box;
...
`Omaicode\Admin\Widgets\Collapse` class used to generate folding components:
```php
use Omaicode\Admin\Widgets\Collapse;
...
`Omaicode\Admin\Widgets\Form` class is used to quickly build a form:
...
`Omaicode\Admin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use Omaicode\Admin\Widgets\InfoBox;
...
`Omaicode\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use Omaicode\Admin\Widgets\Tab;
...
`Omaicode\Admin\Widgets\Table` class is used to generate tables:

```php
use Omaicode\Admin\Widgets\Table;
