...
namespace Omaicode\Enum;

use ReflectionClass;
use JsonSerializable;
use Illuminate\Support\Str;
use Omaicode\Enum\Casts\EnumCast;
use Illuminate\Support\Facades\Lang;
use Illuminate\Support\Traits\Macroable;
use Omaicode\Enum\Contracts\EnumContract;
use Omaicode\Enum\Contracts\LocalizedEnum;
use Illuminate\Contracts\Support\Arrayable;
use Illuminate\Contracts\Database\Eloquent\Castable;
use Omaicode\Enum\Exceptions\InvalidEnumKeyException;
use Omaicode\Enum\Exceptions\InvalidEnumMemberException;
...
abstract class Enum implements EnumContract, Castable, Arrayable, JsonSerializable
{
     ...
     * @return void
     *
     * @throws \Omaicode\Enum\Exceptions\InvalidEnumMemberException
     */
     ...
     * @return static
     *
     * @throws \Omaicode\Enum\Exceptions\InvalidEnumKeyException
     */
